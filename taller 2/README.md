...
Se implementa la función `suma_seno` utilizando la serie de Taylor de $\sin(x)$ mediante una relación recursiva entre términos.
...
- Verificación de `suma_seno_reducida` mediante casos de prueba conocidos.
...
Se modela el decaimiento de una muestra de $N_0=10000$ núcleos con una vida media de $5$ años mediante
